...
import { info, experience, projects } from './data';
          ...
          <>
            ...
            <div className='copy-right'>
              <p>
                ...
                Copyright {new Date().getFullYear()} John Lee
              </p>
            </div>
          </>
        )}
      </>
      {<Navbar homeRef={headerRef} aboutRef={aboutRef} projectRef={projectsRef} contactRef={contactRef} />}
    </>
  );
};
